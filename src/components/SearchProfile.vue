    ...
    <div class="section bg-gray-200 h-screen">
        <div class="container mx-auto h-full flex justify-center items-center">
            <form class="bg-white p-4 w-4/6 relative shadow-xl border-2">
                ...
                <p v-if="this.error" class="pt-4 text-red-400">An Instagram profile with that username could not be found</p>
                <div v-if="this.profile" class="text-center pt-4">
                    <p class="text-sm pb-4">Scroll down to view the profile</p>
                </div>
            </form>
        </div>
    </div>
